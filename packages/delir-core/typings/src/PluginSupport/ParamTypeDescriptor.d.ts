...
export declare type ParameterType = 'COLOR_RGB' | 'COLOR_RGBA' | 'BOOL' | 'STRING' | 'NUMBER' | 'FLOAT' | 'ENUM' | 'ASSET' | 'CODE'
...
export declare type AnyParameterTypeDescriptor = ColorRGBTypeDescripter | ColorRGBATypeDescripter | BoolTypeDescripter | StringTypeDescripter | NumberTypeDescripter | FloatTypeDescripter | EnumTypeDescripter | AssetTypeDescripter | CodeTypeDescripter
...
export declare class TypeDescriptor {
    ...
    public colorRgb(paramName: string, conf: {
        label: string;
        defaultValue?: ColorRGB;
        enabled?: boolean;
        animatable?: boolean;
    }): this
    public colorRgba(paramName: string, conf: {
        label: string;
        defaultValue?: ColorRGBA;
        enabled?: boolean;
        animatable?: boolean;
    }): this
    public bool(paramName: string, conf: {
        label: string;
        defaultValue?: boolean;
        enabled?: boolean;
        animatable?: boolean;
    }): this
    public string(paramName: string, conf: {
        label: string;
        defaultValue?: string;
        enabled?: boolean;
        animatable?: boolean;
    }): this
    public number(paramName: string, conf: {
        label: string;
        defaultValue?: number;
        enabled?: boolean;
        animatable?: boolean;
    }): this
    public float(paramName: string, conf: {
        label: string;
        defaultValue?: number;
        enabled?: boolean;
        animatable?: boolean;
    }): this
    public enum(paramName: string, conf: {
        label: string;
        defaultValue?: string;
        enabled?: boolean;
        selection: string[];
    }): this
    public asset(paramName: string, conf: {
        label: string;
        enabled?: boolean;
        extensions: Array<string>;
    }): this
    public code(paramName: string, conf: {
        label: string;
        enabled?: boolean;
        langType: string;
        defaultValue?: Expression;
...
export default class Type {
    public static colorRgb(paramName: string, option: {
        label: string;
        defaultValue?: ColorRGB;
        enabled?: boolean;
        animatable?: boolean;
    }): TypeDescriptor
    public static colorRgba(paramName: string, option: {
        label: string;
        defaultValue?: ColorRGBA;
        enabled?: boolean;
        animatable?: boolean;
    }): TypeDescriptor
    public static bool(paramName: string, option: {
        label: string;
        defaultValue?: boolean;
        enabled?: boolean;
        animatable?: boolean;
    }): TypeDescriptor
    public static string(paramName: string, option: {
        label: string;
        defaultValue?: string;
        enabled?: boolean;
        animatable?: boolean;
    }): TypeDescriptor
    public static number(paramName: string, option: {
        label: string;
        defaultValue?: number;
        enabled?: boolean;
        animatable?: boolean;
    }): TypeDescriptor
    public static float(paramName: string, option: {
        label: string;
        defaultValue?: number;
        enabled?: boolean;
        animatable?: boolean;
    }): TypeDescriptor
    public static asset(paramName: string, option: {
        label: string;
        enabled?: boolean;
        extensions: string[];
    }): TypeDescriptor
    public static code(paramName: string, option: {
        label: string;
        defaultValue?: Expression;
        enabled?: boolean;
        langType: string;
